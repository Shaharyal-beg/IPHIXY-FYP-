    ...
    <div className='ep_main'>
      ...
      <Head title="Edit_profile" />
        ...
        <div className='divider-ep'>
          ...
          <input className='ep_input' placeholder='Enter your user name'></input>
          ...
          <input className='ep_input' placeholder='Enter your city name'></input>
          ...
          <h1 style={{fontSize:'2vw',fontWeight:'bolder'}}>About</h1>
            ...
            <br /> <input className='ep_input' placeholder='Name of institute' style={{width:'40vw'}}></input>
            <input className='ep_input' placeholder='degree name' style={{width:'40vw'}}></input>
            <input className='ep_input' placeholder='start date'></input>
            <input className='ep_input' placeholder='end date'></input>
            <br />
            ...
            <button  style={{backgroundColor:'#A0A0A0',border:'1px solid white',color:'white',width:'5vw',height:'4vh',borderRadius:'5px'}}>delete Field</button><br />
            <br /> <input className='ep_input' placeholder='organization name' style={{width:'40vw'}}></input>
            <input className='ep_input' placeholder='job title' style={{width:'40vw'}}></input>
            <input className='ep_input' placeholder='start date '></input>
            <input className='ep_input' placeholder='end date'></input>
